    ...
    <>
      <section className='min-h-screen bg-[radial-gradient(hsl(0,72%,65%,40%),hsl(24,62%,73%,40%),hsl(var(--background))_60%)] flex items-center justify-center text-center text-balance flex-col gap-8 px-4'>
        ...
        <p className='text-lg lg:text-3xl max-w-screen-xl'>
          ...
          Capture 85% of the untapped market with location-based dynamic I
          pricing
        </p>
        <SignUpButton>
      ...
      <footer className='container pt-16 pb-8 flex flex-col sm:flex-row justify-between items-start'>
        <div className='flex flex-1 justify-between w-full gap-8'>
...
function Feature({
  ...
  return (
    <div className={cn('flex items-center gap-2', className)}>
      <CheckIcon className='size-4 stroke-accent bg-accent/25 rounded-full p-0.5'></CheckIcon>
      <span>{children}</span>
    </div>
  );
}
